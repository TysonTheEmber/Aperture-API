...
public class ModConf {
  ...
  private static final ForgeConfigSpec.ConfigValue<List<? extends String>> PLAYER_ORDER =
      BUILDER
          //            .comment("")
          .defineList("order", List.of(), ModConf::validate);
  private static final ForgeConfigSpec.ConfigValue<List<? extends String>> REMOVED =
      BUILDER
          //            .comment("")
