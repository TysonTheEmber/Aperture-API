...
public class ClientPayloadManager {
  ...
  private static final Component PUT_GLOBAL_PATH_SUCCESS =
      Component.translatable("gui.camera_anim.client_payload_manager.put_global_path_success");
  private static final Component PUT_GLOBAL_PATH_FAILURE =
      Component.translatable("gui.camera_anim.client_payload_manager.put_global_path_failure");
  private static final Component DELETE_GLOBAL_PATH_SUCCESS =
      Component.translatable("gui.camera_anim.client_payload_manager.delete_global_path_success");
  private static final Component DELETE_GLOBAL_PATH_FAILURE =
      Component.translatable("gui.camera_anim.client_payload_manager.delete_global_path_failure");
  private static final Component GET_GLOBAL_PATH_SUCCESS =
      Component.translatable("gui.camera_anim.client_payload_manager.get_global_path_success");
  private static final Component GET_GLOBAL_PATH_FAILURE =
      Component.translatable("gui.camera_anim.client_payload_manager.get_global_path_failure");

  public void checkGlobalPath(
      int page,
      int size,
      boolean succeed,
      @Nullable List<GlobalCameraPathInfo> paths,
  ...
  public void getGlobalPath(
      @Nullable GlobalCameraPath path,
      boolean succeed,
      int receiver,
      NetworkEvent.Context context) {
    switch (receiver) {
  ...
  public void getNativePath(
    ...
    if (succeed && path != null && entity != null) {
      ...
      net.tysontheember.apertureapi.client.gui.overlay.CutsceneFadeOverlay.startEnterSequence(
          () -> {
            Animator.INSTANCE.setPathAndPlay(
                pth, ent.position().toVector3f(), new Vector3f(0, ent.getYRot(), 0));
            ClientUtil.toThirdView();
          });
    }
  }
