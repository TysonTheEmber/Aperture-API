...
public class JitterPrevention {
    ...
    /**
     * Check if we're very close to a keyframe boundary and apply micro-smoothing
     * This prevents single-frame snaps that can occur due to floating point precision
     * 
     ...
     * This is particularly useful for high refresh rate displays
     * 
