...
/**
 * Minimal model for JSON camera paths used by the loader/registry.
 * This is a lightweight DTO to capture IDs and a few top-level fields.
 * Extend as the feature set is implemented.
 */
public class CameraPathDef {
    ...
    public static class FovDef {
        ...
        public void setDefault(float d) { this._default = d; }
    }

    public static class Vec3Def { public double x, y, z; }

    public static class RotDef { public float yaw, pitch; public float roll = 0f; }
