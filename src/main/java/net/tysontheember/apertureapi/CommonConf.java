...
public class CommonConf {
  ...
  public static final ForgeConfigSpec.BooleanValue CUTSCENE_INVULNERABLE =
      BUILDER
          .comment("If true, players are invulnerable during camera cutscenes.")
          .define("cutscene.invulnerableDuringCutscene", true);

  public static final ForgeConfigSpec.IntValue CUTSCENE_POST_GRACE_TICKS =
      BUILDER
  ...
  public static final ForgeConfigSpec.IntValue CUTSCENE_ENTER_FADE_OUT_TICKS =
      BUILDER
