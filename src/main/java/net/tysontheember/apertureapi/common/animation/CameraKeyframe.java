...
public class CameraKeyframe {
  public static final CameraKeyframe NULL =
      new CameraKeyframe(new Vector3f(Float.MIN_VALUE), new Vector3f(), 0, PathInterpolator.STEP);
  ...
  private CameraKeyframe(
      Vector3f pos,
      Vector3f rot,
      float fov,
      PathInterpolator pathType,
      Vec3BezierController pathBezier,
      TimeInterpolator posType,
      TimeBezierController posBezier,
      TimeInterpolator rotType,
      TimeBezierController rotBezier,
      TimeInterpolator fovType,
  ...
  public CameraKeyframe copy() {
    return new CameraKeyframe(
        ...
        fov,
        pathType,
        new Vec3BezierController(
            new Vector3f(pathBezier.getLeft()), new Vector3f(pathBezier.getRight())),
        posType,
        new TimeBezierController(
            new Vector2f(posBezier.getLeft()), new Vector2f(posBezier.getRight())),
        rotType,
        new TimeBezierController(
            new Vector2f(rotBezier.getLeft()), new Vector2f(rotBezier.getRight())),
        fovType,
        new TimeBezierController(
            new Vector2f(fovBezier.getLeft()), new Vector2f(fovBezier.getRight())));
  }
  ...
  public static CameraKeyframe fromNBT(CompoundTag root) {
    return new CameraKeyframe(
        new Vector3f(
            root.getList("pos", 5).getFloat(0),
            root.getList("pos", 5).getFloat(1),
            root.getList("pos", 5).getFloat(2)),
        new Vector3f(
            root.getList("rot", 5).getFloat(0),
            root.getList("rot", 5).getFloat(1),
            root.getList("rot", 5).getFloat(2)),
        root.getFloat("fov"),
