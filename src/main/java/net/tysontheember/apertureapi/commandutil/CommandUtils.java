...
public class CommandUtils {
    ...
    public static void msgInfo(CommandSourceStack s, String msg) { s.sendSuccess(() -> Component.literal(msg), false); }
    public static void msgWarn(CommandSourceStack s, String msg) { s.sendSuccess(() -> Component.literal("[warn] " + msg), false); }
    public static void msgError(CommandSourceStack s, String msg) { s.sendFailure(Component.literal(msg)); }

    public static ServerLevel level(CommandSourceStack s) { return s.getLevel(); }

    public static float clamp01(float v) { return Math.max(0f, Math.min(1f, v)); }

    public static boolean isDebug() { return DEBUG; }
    public static void setDebug(boolean v) { DEBUG = v; }
    ...
    public static String versionLine() {
        ...
        try {
            var opt = net.minecraftforge.fml.ModList.get().getModContainerById(net.tysontheember.apertureapi.ApertureAPI.MODID);
            if (opt.isPresent()) {
