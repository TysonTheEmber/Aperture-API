...
/**
 * Configuration for a value curve used by the camera animation system. This is intentionally
 * lightweight and uses public fields so it can be serialized/deserialized via Gson as used
