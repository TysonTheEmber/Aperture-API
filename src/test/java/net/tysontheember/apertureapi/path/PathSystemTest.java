...
public class PathSystemTest {
  ...
  public void testPathEvaluation() {
    ...
    PathModel path =
        PathEvaluator.createSimplePath(
            "test", new Vector3f(0, 70, 0), new Vector3f(10, 75, 5), 2.0f);
  ...
  public void testArcLengthParameterization() {
    PathModel path =
        PathEvaluator.createSimplePath("test", new Vector3f(0, 0, 0), new Vector3f(10, 0, 0), 5.0f);
  ...
  public void testConstantSpeedMode() {
    PathModel path =
        PathEvaluator.createSimplePath("test", new Vector3f(0, 0, 0), new Vector3f(20, 0, 0), 5.0f);
  ...
  public void testInterpolationTypes() {
    ...
    assertEquals(
        InterpolationType.CATMULL_UNIFORM, InterpolationType.fromString("catmull:uniform"));
    assertEquals(
        InterpolationType.CATMULL_CENTRIPETAL, InterpolationType.fromString("catmull:centripetal"));
    assertEquals(
        InterpolationType.CATMULL_CHORDAL, InterpolationType.fromString("catmull:chordal"));
  ...
  public void testJSONSerialization() {
    ...
    assertEquals(
        InterpolationType.CATMULL_CENTRIPETAL, deserializedPath.getDefaults().interpolationType);
