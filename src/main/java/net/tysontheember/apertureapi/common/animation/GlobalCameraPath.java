...
public class GlobalCameraPath {
  ...
  private GlobalCameraPath(
      TreeMap<Integer, CameraKeyframe> keyframes, String id, long version, UUID lastModifier) {
  ...
  private GlobalCameraPath(
      TreeMap<Integer, CameraKeyframe> keyframes,
      String id,
      long version,
      UUID lastModifier,
      boolean nativeMode) {
  ...
  public static GlobalCameraPath fromNBT(CompoundTag root) {
    ...
    for (int i = 0; i < list.size(); i++) {
      ...
      map.put(keyframe.getInt("time"), CameraKeyframe.fromNBT(keyframe.getCompound("keyframe")));
    }
  ...
  /**
   * Auto-smooth this camera path to eliminate keyframe jumps. This is a convenience method that
   * applies SmoothingUtils.autoSmoothPath().
   */
  ...
  /**
   * Auto-detect and fix all keyframe jumps in this camera path. This is a one-call solution for
   * smoothing out camera transitions.
   */
