...
/**
 * Catmull-Rom spline evaluator with configurable alpha parameter.
 * alpha = 0.0 (uniform), 0.5 (centripetal), 1.0 (chordal)
 * Implementation based on Mika's Coding Bits article and standard formulations.
 */
public final class CatmullRom {
    ...
    public static Vector3f eval(float t, Vector3f p0, Vector3f p1, Vector3f p2, Vector3f p3, float alpha, Vector3f out) {
        ...
        return out.set(new Vector3f(p1).mul(h00)
