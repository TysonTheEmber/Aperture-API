...
public class InterpolationSettingScreen extends Screen {
    ...
    protected void init() {
        ...
        typeSwitch = CycleButton
                ...
                .create(x + 200, y + 60, 70, 20, TYPE, (btn, value) -> {
        ...
        typeSwitch.setTooltip(Tooltip.create(Component.translatable(typeSwitch.getValue().getDisplayNameKey() + ".tooltip")));
        ...
        addRenderableWidget(net.minecraft.client.gui.components.Button.builder(EASY_IN, b -> {
            left.set(0.42f, 0);
            right.set(1, 1);
            bezier1.update();
            bezier2.update();
        }).pos(x + 100, y + 60).size(80, 20).tooltip(net.minecraft.client.gui.components.Tooltip.create(Component.translatable("gui.camera_anim.interpolation_setting.easy_in.tooltip"))).build());
        addRenderableWidget(net.minecraft.client.gui.components.Button.builder(EASY_OUT, b -> {
            left.set(0, 0);
            right.set(0.58f, 1);
            bezier1.update();
            bezier2.update();
        }).pos(x + 100, y + 80).size(80, 20).tooltip(net.minecraft.client.gui.components.Tooltip.create(Component.translatable("gui.camera_anim.interpolation_setting.easy_out.tooltip"))).build());
        addRenderableWidget(net.minecraft.client.gui.components.Button.builder(EASY_IN_OUT, b -> {
            left.set(0.42f, 0);
            right.set(0.58f, 1);
            bezier1.update();
            bezier2.update();
        }).pos(x + 100, y + 100).size(80, 20).tooltip(net.minecraft.client.gui.components.Tooltip.create(Component.translatable("gui.camera_anim.interpolation_setting.easy_in_out.tooltip"))).build());
        addRenderableWidget(net.minecraft.client.gui.components.Button.builder(EASY, b -> {
            left.set(0.25f, 0.1f);
            right.set(0.25f, 1);
            bezier1.update();
            bezier2.update();
        }).pos(x + 100, y + 120).size(80, 20).tooltip(net.minecraft.client.gui.components.Tooltip.create(Component.translatable("gui.camera_anim.interpolation_setting.easy.tooltip"))).build());
