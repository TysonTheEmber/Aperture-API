...
/**
 * Minimal data object describing how the camera should follow a target during a segment. Currently
 * unused by server commands, but available for JSON definitions.
 */
