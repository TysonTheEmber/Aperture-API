...
/**
 * Fixed-sample arc-length lookup table for a curve segment P(t), t in [0,1].
 * Provides t->s and s->t mappings for constant-speed traversal.
 */
public final class ArcLengthLUT {
    ...
    public float totalLength() { return totalLength; }
